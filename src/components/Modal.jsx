    ...
    <Dialog as="div" className="relative z-10" onClose={onClose}>
      ...
      <div className="fixed inset-x-4 inset-y-[1%] mt-16 overflow-y-auto">
        <div className="flex min-h-[98%] items-center justify-center">
          ...
          >
            <Dialog.Panel className="relative max-h-[550px] transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-12 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              <button
                type="button"
                title="Close"
